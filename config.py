class Config:
    def __init__(self, sr=16000, capture_sec=0.5, dataset_frame_overlap=0.1, n_fft=512, n_filters=32, n_mfcc=20, window_type='hamming', window_ms=30, window_overlap=0.2):
